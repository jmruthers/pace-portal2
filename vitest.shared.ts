...
export const domUnitTestTsFiles: string[] = [
  'src/hooks/contacts/useContactFormState.test.ts',
  'src/hooks/member-profile/useAddressOperations.test.ts',
  'src/hooks/member-profile/useMemberProfileData.test.ts',
  'src/integrations/google-maps/loader.test.ts',
  'src/integrations/google-maps/loadGoogleMapsWithPlaces.test.ts',
];
