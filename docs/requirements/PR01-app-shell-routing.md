...
- App boot reaches `/login`, `/dashboard`, `/profile-complete`, `/:eventSlug`, `/:eventSlug/application`, `/:eventSlug/applications/:applicationId`, and `/:eventSlug/:formSlug` with the expected shell behavior.
